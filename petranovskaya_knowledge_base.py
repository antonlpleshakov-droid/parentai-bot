...
PETRANOVSKAYA_KNOWLEDGE = {
    ...
    "crying_and_comfort": {
        "petranovskaya_approach": [
            "Плач - это способ общения ребенка, а не манипуляция",
            "Нельзя 'избаловать' ребенка, удовлетворяя его потребности",
            "Ребенок плачет, потому что ему плохо, а не чтобы досадить родителям",
            "Игнорирование плача разрушает привязанность"
        ],
        "what_to_do": [
            "Всегда реагируйте на плач ребенка",
            "Проверьте физические потребности: голод, холод, мокрый подгузник",
            "Если физических причин нет, просто будьте рядом",
            "Не оставляйте ребенка плакать одного",
            "Обнимайте, носите на руках, говорите ласково"
        ],
        "common_mistakes": [
...
def format_petranovskaya_response(topic, age_group=None):
    """Format response based on Петрановская's principles."""
    ...
    response += f"\nЭто основано на теории привязанности и принципах, описанных в книге 'Тайная опора'."
